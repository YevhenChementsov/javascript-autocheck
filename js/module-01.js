...
// console.log('Цена за единицу:', pricePerItem);
...
// console.log('Новое название продукта:', productName);
// pricePerItem = pricePerItem + 1500;
// console.log('Новая цена за единицу:', pricePerItem);

// ==========  Задача №3  ==========

// const topSpeed = 160;
// console.log('Максимальная скорость:', topSpeed);
...
// console.log('Количество:', orderedQuantity);
...
// console.log('Цена за единицу:', pricePerDroid);
